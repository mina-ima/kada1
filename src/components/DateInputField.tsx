...
const DateInputField: React.FC<DateInputFieldProps> = ({ label, value, onChange, placeholder }) => {
  ...
  return (
    <div className="mb-4">
      <label htmlFor={label} className="block text-gray-700 text-3xl font-bold mb-2 text-left">
        {label}
      </label>
      <input
        type="text"
        ...
        className="shadow appearance-none border rounded w-full py-1 px-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline input-text-size"
      />
      <input
        type="date"
        ref={dateInputRef}
